    ...
    <div class="flex justify-between items-center">
        ...
        <div class="hidden md:flex items-center space-x-8">
            ...
            <div class="dropdown relative">
                <a href="fasilitas" class="{{request ()-> is ('fasilitas') ? ' text-green-700 font-md' : ' hover:text-green-600'}}">Fasilitas</a>
            ...
            <!-- Tautan Dropdown -->
            <div class="dropdown relative">
                <a href="tautan" class="{{request ()-> is ('home') ? 'text-green-700 font-md' : 'hover:text-gray-600'}}">Tautan</a>
                <div class="dropdown-content bg-white shadow-lg rounded-md mt-2">
            ...
            <!-- PMB Online Dropdown -->
            <div class="dropdown relative">
                <a href="#pmb" class="{{request ()-> is ('home') ? 'text-green-700 font-md' : 'hover:text-gray-600'}}">PMB Online</a>
                <div class="dropdown-content bg-white shadow-lg rounded-md mt-2">
                ...
                <nav class="space-y-4">
                    ...
                    <div class="mobile-dropdown">
                        ...
                        <div class="hidden pl-4 mt-2 space-y-2">
                            ...
                            <a href="https://pustaka.sttcipasung.ac.id/" class="block text-gray-600 hover:text-green-600">Digital Library</a>
                        </div>
                    </div>
...
<div class="bg-gray-900 py-12">
    <div class="text-center">
      <h1 class="text-3xl font-semibold text-white">Layanan</h1>
      <nav class="mt-4">
        <ol class="flex justify-center text-gray-300 text-sm">
  ...
  <div class="bg-gray-700 py-6">
    <div class="text-center">
      <p class="text-white">
        Ayo kuliah di <span class="font-semibold text-blue-400">STTC</span>, daftar 
        <span class="font-bold text-white">Sekarang!</span>
      </p>
    </div>
  </div>
