...
<header class="container mx-auto px-4 py-6">
        ...
        <div class="mt-4 flex items-center">
            <img src="/img/sj.jpg" alt="Foto Penulis" class="rounded-full w-10 h-10 mr-3">
            <div>
                <h1 class="text-xl font-semibold">Ganang Aji Pratama</h1>
    ...
    <main class="container mx-auto px-4 py-10 mb-20">
        <article class="bg-white p-6 shadow-md rounded-md">
            <h2 class="text-2xl font-bold mb-4">Kegiatan Mahasiswa Baru</h2>
            <p class="text-gray-700 leading-relaxed mb-4">
                Mahasiswa baru di STTC diajak untuk mengikuti serangkaian kegiatan yang dirancang untuk membantu mereka beradaptasi dengan lingkungan kampus. Program ini meliputi orientasi akademik, kegiatan pengembangan diri, dan berbagai acara yang mempererat solidaritas antar mahasiswa.
            </p>
            <p class="text-gray-700 leading-relaxed mb-4">
                Dalam program ini, mahasiswa tidak hanya diperkenalkan pada fasilitas dan sumber daya kampus, tetapi juga dibekali keterampilan dasar yang penting untuk mendukung kesuksesan studi mereka. Kegiatan ini melibatkan dosen, alumni, dan mahasiswa senior sebagai mentor.
            </p>
            <p class="text-gray-700 leading-relaxed">
                Dengan mengikuti kegiatan ini, mahasiswa baru diharapkan mampu membangun karakter yang kuat, menjalin hubungan baik dengan sesama mahasiswa, dan memulai perjalanan akademik mereka dengan langkah yang mantap.
            </p>
        </article>
    </main>
