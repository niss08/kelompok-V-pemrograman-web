...
<header class="container mx-auto px-4 py-6">
        ...
        <div class="mt-4 flex items-center">
            <img src="/img/e.jpg" alt="Foto Penulis" class="rounded-full w-10 h-10 mr-3">
            <div>
                <h1 class="text-xl font-semibold">Eko Aja</h1>
    ...
    <main class="container mx-auto px-4 py-10 mb-20">
        <article class="bg-white p-6 shadow-md rounded-md">
            <h2 class="text-2xl font-bold mb-4">Prestasi Gemilang Mahasiswa STTC</h2>
            <p class="text-gray-700 leading-relaxed mb-4">
            Mahasiswa STTC telah mencapai berbagai prestasi yang membanggakan baik di tingkat nasional maupun internasional 
            </p>
            <p class="text-gray-700 leading-relaxed mb-4">
            Mereka berhasil memenangkan kompetisi robotika dengan inovasi robot otomatis yang unggul serta memperoleh medali emas di ajang hackathon internasional berkat pengembangan aplikasi untuk menyelesaikan masalah sosial 
            </p>
            <p class="text-gray-700 leading-relaxed">
            Selain itu mahasiswa juga berhasil mendirikan startup berbasis teknologi yang mendapatkan pendanaan besar Prestasi ini mencerminkan semangat inovasi dan keunggulan yang menjadi ciri khas mahasiswa STTC
            </p>
        </article>
    </main>
