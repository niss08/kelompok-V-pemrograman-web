...
<div id="sidebar" class="fixed inset-0 bg-gray-800 bg-opacity-50 z-30 hidden">
    ...
    <div class="container mx-auto px-4">
        <h2 class="text-3xl font-bold text-center mb-8">Ruang Kelas</h2>
        <div class="flex flex-col items-center">
            <img 
                class="w-full max-w-3xl rounded-lg shadow-xl dark:shadow-gray-800 mb-8" 
                src="/img/kelass.jpg" 
                alt="Ruang Kelas STT Cipasung"
            >
            <div class="max-w-3xl text-center">
                <p class="text-gray-700 text-lg leading-relaxed mb-4">
                    Ruang kelas di STT Cipasung dirancang dengan konsep modern yang mendukung proses pembelajaran yang efektif. Setiap ruangan dilengkapi dengan fasilitas penunjang seperti proyektor, papan tulis, pendingin ruangan, dan penataan kursi yang nyaman untuk menciptakan suasana belajar yang kondusif.
                </p>
                <p class="text-gray-700 text-lg leading-relaxed">
                    Dengan kapasitas ideal 30-40 mahasiswa per kelas, ruangan ini memungkinkan interaksi yang optimal antara dosen dan mahasiswa. Pencahayaan dan ventilasi yang baik juga menjadi prioritas untuk memastikan kenyamanan selama proses belajar mengajar berlangsung.
                </p>
            </div>
        </div>
    </div>
