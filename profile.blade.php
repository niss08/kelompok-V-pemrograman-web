...
<div id="sidebar" class="fixed inset-0 bg-gray-800 bg-opacity-50 z-30 hidden">
  ...
  <div class="grid md:grid-cols-2 items-center">
    ...
    <div class="bg-white p-20">
      <h2 class="text-4xl font-medium mb-8">Profile STT Cipasung</h2>
      
      <div class="mb-6">
        <p class="text-green-600 font-medium mb-2">Tahun Berdiri</p>
        <p class="text-4xl text-green-600 font-medium mb-8">1997</p>
      </div>
      
      <p class="text-gray-700 leading-relaxed">
        Sekolah Tinggi Teknologi Cipasung (STT Cipasung) didirikan tahun 1997 
        dengan bantuan dan arahan dari tim Institut Teknologi Bandung. 
        Sekolah tinggi ini didirikan untuk menjawab tantangan penyediaan 
        tenaga ahli profesional dalam bidang keteknikan yang dibutuhkan oleh 
        masyarakat, khususnya masyarakat di sekitar pesantren dan daerah 
        pinggiran yang selama ini kurang mendapatkan perhatian.
      </p>
    </div>
  </div>
</section>
