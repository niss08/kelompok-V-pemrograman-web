...
<header class="container mx-auto px-4 py-6">
    ...
    <main class="container mx-auto px-4 py-10 mb-20">
        <article class="bg-white p-6 shadow-md rounded-md">
            <h2 class="text-2xl font-bold mb-4">Workshop Teknologi Terbaru</h2>
            <p class="text-gray-700 leading-relaxed mb-4">
            STTC secara rutin mengadakan workshop teknologi untuk mahasiswa dan masyarakat umum Workshop ini memberikan pelatihan langsung di berbagai bidang seperti pengembangan web kecerdasan buatan dan blockchain
            </p>
            <p class="text-gray-700 leading-relaxed mb-4">
            Peserta workshop tidak hanya mendapatkan teori tetapi juga praktek langsung dengan instruktur ahli di bidangnya
            </p>
            <p class="text-gray-700 leading-relaxed">
            Workshop ini bertujuan untuk memperkenalkan teknologi terbaru sekaligus membekali peserta dengan keterampilan yang sesuai dengan kebutuhan industri saat ini
