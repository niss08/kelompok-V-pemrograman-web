...
<header class="container mx-auto px-4 py-6">
        ...
        <div class="mt-4 flex items-center">
            <img src="/img/ad.jp.jpg" alt="Foto Penulis" class="rounded-full w-10 h-10 mr-3">
            <div>
                <h1 class="text-xl font-semibold">Abdul Ropi</h1>
    ...
    <main class="container mx-auto px-4 py-10 mb-20">
        <article class="bg-white p-6 shadow-md rounded-md">
            <h2 class="text-2xl font-bold mb-4">Inovasi Teknologi Di STTC</h2>
            <p class="text-gray-700 leading-relaxed mb-4">
            STTC terus menjadi pelopor dalam pengembangan teknologi terkini dengan berbagai proyek inovatif Kampus ini memperkenalkan konsep smart campus yang memanfaatkan teknologi IoT
            </p>
            <p class="text-gray-700 leading-relaxed mb-4">
            efisiensi fasilitas dan pelayanan Kampus juga memiliki laboratorium kecerdasan buatan yang mendukung penelitian di bidang artificial intelligence serta mengembangkan solusi untuk kebutuhan industri 
            </p>
            <p class="text-gray-700 leading-relaxed">
            Selain itu mahasiswa STTC berkolaborasi dengan startup untuk menciptakan aplikasi dan perangkat lunak inovatif yang relevan dengan kebutuhan pasar
