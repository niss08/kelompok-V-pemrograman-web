...
<header class="container mx-auto px-4 py-6">
        ...
        <div class="mt-4 flex items-center">
            <img src="/img/H.jpg" alt="Foto Penulis" class="rounded-full w-10 h-10 mr-3">
            <div>
                <h1 class="text-xl font-semibold">Handayani</h1>
    ...
    <main class="container mx-auto px-4 py-10 mb-20">
        <article class="bg-white p-6 shadow-md rounded-md">
            <h2 class="text-2xl font-bold mb-4">Belajar efektif</h2>
            <p class="text-gray-700 leading-relaxed mb-4">
            Artikel ini membahas strategi belajar yang efektif untuk membantu mahasiswa meningkatkan hasil akademik.
            </p>
            <p class="text-gray-700 leading-relaxed mb-4">
            Strategi ini mencakup cara mengelola waktu dengan baik mengatur jadwal belajar yang terstruktur dan memastikan fokus saat belajar dengan teknik tertentu Mahasiswa juga diajak untuk lebih aktif selama pembelajaran di kelas
            </p>
            <p class="text-gray-700 leading-relaxed">
            Artikel ini bertujuan untuk memberikan panduan sederhana namun efektif sehingga mahasiswa dapat lebih produktif dalam belajar
            </p>
        </article>
    </main>
