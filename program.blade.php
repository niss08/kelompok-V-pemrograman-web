...
<div id="sidebar" class="fixed inset-0 bg-gray-800 bg-opacity-50 z-30 hidden">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
        <div class="flex flex-col md:flex-row items-center md:items-start space-y-4 md:space-y-0 md:space-x-6">
            <img src="/img/if.jpg" alt="Teknik Informatika" class="w-full md:w-60 md:h-60 object-cover rounded-md">
            <div>
                <h2 class="text-2xl font-bold text-green-600 mb-2">Teknik Informatika</h2>
                <p class="text-gray-600">Program studi Teknik Informatika bertujuan untuk membentuk lulusan yang unggul dalam bidang teknologi informasi, pengembangan perangkat lunak, dan solusi teknologi kreatif.</p>
            </div>
        </div>

        <div class="flex flex-col md:flex-row items-center md:items-start space-y-4 md:space-y-0 md:space-x-6">
            <img src="/img/ti.jpg" alt="Teknik Industri" class="w-full md:w-60 md:h-60 object-cover rounded-md">
            <div>
                <h2 class="text-2xl font-bold text-green-600 mb-2">Teknik Industri</h2>
                <p class="text-gray-600">Program studi Teknik Industri berfokus pada manajemen sistem industri, optimalisasi proses produksi, dan pengembangan efisiensi dalam berbagai sektor industri.</p>
            </div>
        </div>
    </div>
</div>
