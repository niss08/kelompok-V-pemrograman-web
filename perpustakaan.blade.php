                ...
                <a href="home" class="text-gray-600 hover:text-green-600">Home</a>
                    ...
                    <div class="mobile-dropdown">
                        ...
                        <div class="hidden pl-4 mt-2 space-y-2">
                            ...
                            <a href="#" class="block text-gray-600 hover:text-green-600">Digital</a>
                        </div>
                    </div>
...
<section id="profil" class="bg-gray-50 py-20">
   <div class="container mx-auto px-4">
       <h2 class="text-3xl font-bold text-center mb-8">Perpustakaan</h2>
       <div class="flex flex-col items-center">
           ...
           <div class="max-w-3xl text-center">
               <p class="text-gray-700 text-lg leading-relaxed mb-4 py-4">
                   Perpustakaan STT Cipasung merupakan pusat sumber belajar yang menyediakan berbagai koleksi buku, jurnal, dan referensi akademik untuk mendukung kegiatan pembelajaran dan penelitian mahasiswa serta dosen.
               </p>
               <p class="text-gray-700 text-lg leading-relaxed">
                   Dilengkapi dengan fasilitas modern seperti area membaca yang nyaman, koneksi internet, dan sistem pencarian digital, perpustakaan ini berkomitmen untuk memfasilitasi pengembangan ilmu pengetahuan dan teknologi di lingkungan kampus.
               </p>
           </div>
       </div>
   </div>
